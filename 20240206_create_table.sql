...
IF NOT EXISTS product (       productid         CHAR (3) NOT NULL,
                            ...
                            productionprice   NUMERIC (7,2) NOT NULL,
...
DROP TABLE
IF EXISTS store (     storeid  VARCHAR (3) NOT NULL,
...
INSERT INTO cateogry VALUES ('FW', 'Footwear');
