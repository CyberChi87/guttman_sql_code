...
--
-- Table structure for table `guttman_classdb_assign1`
--

DROP TABLE IF EXISTS `guttman_classdb_assign1`;
CREATE TABLE IF NOT EXISTS `guttman_classdb_assign1` (
...
--
-- Dumping data for table `guttman_classdb_assign1`
--

INSERT INTO `guttman_classdb_assign1` (`employeeNumber`, `lastName`, `firstName`, `extension`, `email`, `officeCode`, `reportsTo`, `jobTitle`) VALUES
...
ALTER TABLE `customers`
  ADD CONSTRAINT `customers_ibfk_1` FOREIGN KEY (`salesRepEmployeeNumber`) REFERENCES `guttman_classdb_assign1` (`employeeNumber`);

--
-- Constraints for table `guttman_classdb_assign1`
--
ALTER TABLE `guttman_classdb_assign1`
  ADD CONSTRAINT `guttman_classdb_assign1_ibfk_1` FOREIGN KEY (`reportsTo`) REFERENCES `guttman_classdb_assign1` (`employeeNumber`),
  ADD CONSTRAINT `guttman_classdb_assign1_ibfk_2` FOREIGN KEY (`officeCode`) REFERENCES `offices` (`officeCode`);
